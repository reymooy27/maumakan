  ...
  if (error || !profile || "error" in profile) {
    return (
      <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center space-y-4 p-4 text-center">
        ...
        <Link
          href="/"
          className="mt-4 px-8 py-3 bg-orange-600 text-white rounded-2xl font-bold shadow-lg shadow-orange-600/20 active:scale-95 transition-all"
        >
          Kembali ke Map
        </Link>
      </div>
